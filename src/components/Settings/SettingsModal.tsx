...
export function SettingsModal({ open, initialTab, onClose, theme, onToggleTheme, docs, ai, tools, editorPrefs }: SettingsModalProps) {
        ...
        <div className="settings-body scroll-thin">
          {tab === 'general' && (
            <>
              ...
              <section className="ai-panel-section">
                <h3 className="ai-panel-subtitle">{t('settings.editor')}</h3>
                <label className="field-label" htmlFor="quick-format-delay">{t('settings.quickFormatDelay')}</label>
                <input
                  ...
                  onChange={(e) => editorPrefs.update({ quickFormatDelayMs: Number(e.target.value) })}
                />
                <p className="field-hint">{t('settings.quickFormatDelayHint')}</p>
              </section>
            ...
            <>
              ...
              <section className="ai-panel-section">
                ...
                <div className="tool-enable-row">
                  <span className="tool-enable-label">
                    <AutocompleteIcon />
                    {t('ai.autocomplete')}
                  </span>
                  <button

...
export const translations = {
  es: {
    ...
    'toolbar.footnote': 'Insertar nota al pie',
    ...
    'contextMenu.aiImagePlaceholder':
      'Describe la imagen que quieres crear (ej: un zorro leyendo un libro bajo un árbol)',
    ...
    'ai.model': 'Modelo',
    'ai.modelFallbackHint':
      'No se pudo obtener la lista de modelos de este proveedor; escribe el identificador manualmente.',
    'ai.apiKeyStorageHint':
      'Se guarda solo en este navegador (localStorage), nunca sale de tu equipo.',
  ...
  en: {
    ...
    'contextMenu.aiImagePlaceholder':
      'Describe the image you want to create (e.g.: a fox reading a book under a tree)',
    ...
    'contextMenu.aiDescribeDefaultPrompt':
      'Describe this image in enough detail to use as alt text or a caption.',
    ...
    'ai.model': 'Model',
    'ai.modelFallbackHint':
      "Couldn't fetch this provider's model list; type the model id manually.",
    'ai.apiKeyStorageHint':
      'Stored only in this browser (localStorage), it never leaves your machine.',
